...
public class LogAspect {
	...
	@Around("@within(com.example.fw.common.reports.ReportCreator)")
	public Object aroundReportCreatorLog(final ProceedingJoinPoint jp) throws Throwable {
		// サービスクラスと同じログを出力
		return aroundServiceLog(jp);
	}
}
