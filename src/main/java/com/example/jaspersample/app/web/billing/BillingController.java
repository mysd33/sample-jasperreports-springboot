...
public class BillingController {
    ...
    /**
     * 請求書（PDF）を出力する その3<br>
     * <p>
     * 請求書の様式が、単項目含めてすべてJRDataSourceから取得する版<br/> CSVファイルを入力として、帳票出力する。
     *
     * @return 請求書のPDFファイル
     */
    ...
    /**
     * 請求書（PDF）を出力する その4<br>
     * <p>
     * 請求書の様式が、単項目含めてすべてJRDataSourceから取得する版<br/> PDF電子署名ありの例
     *
     * @return 請求書のPDFファイル
     */
